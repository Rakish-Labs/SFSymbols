    ...
    class ImageExtensionTests: XCTestCase {
        /// Tests, whether the `Image` retrieved via SFSymbols is equal to the one retrieved via the `String` initializer
        func testInit() {
            if #available(iOS 13.0, macOS 11.0, tvOS 13.0, watchOS 6.0, visionOS 1.0, *) {
                ...
                XCTFail("iOS 13, macOS 11.0, tvOS 13 or watchOS 6.0 is required to test SFSymbols.")
            }
        }
