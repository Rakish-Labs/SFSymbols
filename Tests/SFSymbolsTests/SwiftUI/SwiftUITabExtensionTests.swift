    ...
    class TabExtensionTests: XCTestCase {
        /// Tests, whether the `Tab` retrieved via SFSymbols can be retrieved without a crash
        func testInit() {
            if #available(iOS 18.0, macOS 15.0, tvOS 18.0, watchOS 11.0, visionOS 2.0, *) {
                ...
                print(
                    "To test the Tab initializer, iOS 18, macOS 15.0, tvOS 18, watchOS 11, or visionOS 2.0 is required."
                )
            }
        }
    }
