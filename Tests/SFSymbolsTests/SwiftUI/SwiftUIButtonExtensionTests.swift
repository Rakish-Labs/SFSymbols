@testable import SFSymbols
    ...
    import XCTest
        ...
        class ButtonExtensionTests: XCTestCase {
            /// Tests, whether the `Label` retrieved via SFSymbols can be retrieved without a crash
            func testInit() {
                if #available(iOS 14.0, macOS 11.0, tvOS 14.0, watchOS 7.0, *) {
                    ...
                    print(
                        "To test the Button initializer, iOS 14, macOS 11.0 or tvOS 14 is required."
                    )
                }
            }
        }
