...
class VariantTests: XCTestCase {
    ...
    func testSquareVariant() throws {
        let exclamationmarkSquare = SFSymbol.exclamationmarkSquare
        XCTAssertEqual(exclamationmarkSquare.baseSymbol, SFSymbol.exclamationmark)
        XCTAssertEqual(exclamationmarkSquare.variantType, "square")
        XCTAssertTrue(exclamationmarkSquare.isVariant)
    }
    ...
    func testBaseSymbolsExcludesVariants() throws {
        ...
        XCTAssertFalse(baseSymbols.contains(SFSymbol.exclamationmarkSquare))
    ...
    func testAllVariantsNotInBaseSymbols() throws {
        ...
        for variant in knownVariants {
            XCTAssertFalse(
                baseSymbols.contains(variant), "\(variant.rawValue) should not be in baseSymbols")
        }
    }
